...
async def ainvoke_grade_documents_step(
    ...
    if runtime.context.langfuse_enabled and runtime.context.trace:
        try:
            span = runtime.context.trace.create_span(
            ...
            logger.warning(f"Failed to create Langfuse span for document grading: {e}")
    if not context:
    ...
    logger.info(f"Grading result: {'relevant' if is_relevant else 'not_relavant'}, routing to: {route}")
