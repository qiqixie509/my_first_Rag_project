...
class QueryBuilder:
    ...
    def _build_text_query(self)->Dict[str, Any]:
        """Build the text query part of the OpenSearch query body."""
        return {
            "multi_match": {
                "query": self.query,
                "fields": self.fields,
    ...
    def _build_filters(self)->List[Dict[str, Any]]:
        ...
        filters = []
        if self.categories:
            filters.append({"terms": {"category": self.categories}})
        return filters
    ...
    def _build_source_fields(self)->List[str]:
        ...
        if self.search_chunks:
            ...
            return ["arxiv_id", "title", "authors", "category", "published_date", "pdf_url"]


    def _build_highlight(self)->Dict[str, Any]:
        """Build the highlight part of the OpenSearch query body."""
        if self.search_chunks:
            return {
                "fields": {
                    "chunk_text": {
    ...
    def _build_query(self)->Dict[str, Any]:
        """Build the query part of the OpenSearch query body."""
